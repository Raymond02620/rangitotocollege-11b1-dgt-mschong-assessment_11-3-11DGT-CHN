...
rules_button.config(command=lambda: (save_data(), game_window.destroy(), subprocess.Popen(["python3", "Python/rps_rules.py", username])))
galore_button.config(command=lambda: (save_data(), game_window.destroy(), subprocess.Popen(["python3", "Python/rps_galore.py", username])))
