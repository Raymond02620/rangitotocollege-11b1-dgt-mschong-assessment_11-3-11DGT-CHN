...
exit_button = Button(rule_window, text = "Back to main menu", font = ("MS Serif", 20), padx = 10, pady = 10, bd = 5, fg = "#E33D2B", bg = "#3F28EE", activebackground="#334EC4", activeforeground="#D71F47", relief = RAISED, height = 2, width = 10, command = lambda: ( rule_window.destroy(), subprocess.Popen(["python3", "Python/rps.py", username ])))
